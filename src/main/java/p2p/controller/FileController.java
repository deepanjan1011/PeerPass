...
public class FileController {
    ...
    public FileController(int port) throws IOException {
        ...
        this.uploadDir = System.getProperty("java.io.tmpdir") + File.separator + "peerpass-uploads";
    ...
    private class UploadHandler implements HttpHandler{
        ...
        public void handle(HttpExchange exchange) throws IOException{
            ...
            try {
                ...
                // Copy input stream to byte array output stream
    ...
    private static class Multiparser{
        ...
        public ParseResult parse(){
            try {
                ...
                String contentType = "application/octet-stream"; // By-Default
                ...
                System.out.println("Error parsing multiport data "+ex.getMessage());
                return null;
            }
        }
                ...
                for(int i = startPos;i <= data.length - sequence.length;i++){
                    for(int j = 0;j < sequence.length;j++){
                        if(data[i+j] != sequence[j]){
                            continue outer;//recursive way of writing
                        }
                    }
                    return i;
                }
            ...
            try {
                ...
                try(Socket socket = new Socket("localhost", port)){
                    ...
                    try(FileOutputStream fos = new FileOutputStream(tempFile)){
                        ...
                        // Read file content in chunks - buffer size increased for better performance
                        ...
                        while((bytesRead = socketInput.read(buffer)) != -1){
                            ...
                            // Clear buffer for next iteration to prevent data contamination
                            // This is the Java equivalent of "bytes.erase()" - clearing the buffer
                ...
                System.out.println("Error downloading the file "+ex.getMessage());
